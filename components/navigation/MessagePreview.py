...
class MessagePreview:
    ...
    def __init__(self, master, sender, content, highlighted):
        ...
        self.frm_message_preview = tk.Frame(master, highlightbackground=highlighted_background, highlightthickness=2, cursor="hand2")
        self.message_sender = tk.Label(self.frm_message_preview, text=sender, anchor=tk.W, bg="white")
        self.message_sender.configure(font=("Open Sans", 10, "bold"))
        self.message_sender.pack(side=tk.TOP, fill=tk.X)
        self.message_content_preview = tk.Label(self.frm_message_preview, text=content, anchor=tk.W, bg="white")
